    ...
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <section>
                ...
                <table id="starredApplicationsTable" class="table table-striped" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th class="th-sm">ID</th>
                            <th class="th-sm">Applicant Name</th>
                            <th class="th-sm">For Position</th>
                            <th class="th-sm">Date Starred</th>
