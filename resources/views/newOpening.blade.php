    ...
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <section>
                ...
                <form role="form" action="#" method="POST" id="new_opening_form">
                    <div class="form-group">
                        <label for="job_title">Job Title:</label>
                        <input type="text" id="job_title" name="job_title" class="form-control" placeholder="Job Title" required="required" />
                    </div>
                    <div class="form-group">
                        <label for="job_location">Location:</label>
                        <input type="text" id="job_location" name="job_location" class="form-control" placeholder="Job Title" required="required" />
                    </div>
                    <div class="form-group">
                        <label for="qualification">Minimum Qualification:</label>
                        <select id="qualification" name="qualification" class="form-control" required="required">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="job_description" name="job_description" class="form-control" required="required"></textarea>
                    </div>
                    <div class="form-group">
